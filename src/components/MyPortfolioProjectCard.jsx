      ...
      <div className="relative flex flex-col items-start justify-center h-full border rounded-2xl w-70 md:w-100 text-[#31302D] shadow-lg shadow-black/30">
        <header className="flex flex-row items-center gap-8 p-4">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-bold font-antonio">{projectTitle}</h1>
        ...
        <main className="p-4 py-1 font-mono">
          <h2 className="text-lg font-semibold font-antonio">KEY FEATURES:</h2>
        ...
        <hr className="w-full my-1" />
        <section className="p-4 py-1 font-mono">
        ...
        <section className="flex flex-col items-center justify-center w-full gap-2 p-4 font-mono">
          <button
            ...
            className="flex flex-row items-center justify-center w-full gap-2 px-4 py-2 text-xs border rounded-2xl bg-[#C6BF8B]"
          >
            <svg
