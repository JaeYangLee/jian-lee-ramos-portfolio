  ...
  return (
    <>
      <div className="w-full h-full bg-[#F9EEE8]">
        <header className="flex flex-col gap-4 p-4 pt-12 md:px-24">
          <h1 className="text-3xl md:text-4xl font-bold text-center md:text-left font-antonio text-[#31302D]">
            MY SOFTWARE DEVELOPMENT PROJECTS
          </h1>
          <h3 className="hidden font-mono text-xs text-justify md:flex text-[#31302D]">
